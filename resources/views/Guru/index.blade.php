                        ...
                        <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                                ...
                                <tr class="border-b dark:border-gray-700">
                                    ...
                                    <td class="px-4 py-3">
                                        <img style="width: 100px; height: 100px;" src="{{ asset('storage/'.$siswa->foto) }}" alt="{{ $siswa->foto }}">
                                    </td>

                                    <td class="px-4 py-3">
                                        @php
                                            $badgeClass = $siswa->status == 'sedang dalam tinjauan' ? 'badge-danger' :
                                                          ($siswa->status == 'done' ? 'badge-success' : 'badge-secondary');
                                        @endphp
                                    ...
                                    <td class="px-4 py-3">
                                        <a href="#">
                                            <button type="button" class="text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">Show</button>
                                        </a>
